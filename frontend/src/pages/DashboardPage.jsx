...
const DashboardPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-sky-50 via-indigo-50 to-purple-50 overflow-hidden relative">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <motion.div
          ...
          className="absolute top-20 left-10 w-64 h-24 bg-gradient-to-r from-white/30 to-white/10 rounded-full blur-xl"
        />
        <motion.div
          animate={{ x: [0, -150, 0] }}
          transition={{ duration: 25, repeat: Infinity, ease: "linear" }}
          className="absolute top-40 right-20 w-48 h-20 bg-gradient-to-r from-indigo-200/20 to-purple-200/10 rounded-full blur-xl"
        />
        ...
        <motion.div
          ...
          className="absolute bottom-20 left-5 w-40 h-10 bg-gradient-to-r from-emerald-300/20 to-teal-300/10 rounded-full blur-md"
        />
        <motion.div
          animate={{ y: [0, 15, 0] }}
          transition={{ duration: 12, repeat: Infinity, ease: "easeInOut" }}
          className="absolute bottom-32 right-10 w-32 h-8 bg-gradient-to-r from-amber-300/20 to-orange-300/10 rounded-full blur-md"
        />
        ...
        {[...Array(8)].map((_, i) => (
          <motion.div
            ...
            className={`absolute w-${Math.floor(Math.random() * 12) + 4} h-${Math.floor(Math.random() * 12) + 4} rounded-full bg-gradient-to-r from-indigo-300/10 to-purple-300/10 blur-sm`}
            style={{
        ...
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-gradient-to-r from-indigo-300/20 via-purple-300/20 to-pink-300/20 rounded-full mix-blend-screen blur-3xl animate-pulse" />
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-gradient-to-r from-cyan-300/20 via-blue-300/20 to-indigo-300/20 rounded-full mix-blend-screen blur-3xl animate-pulse delay-1000" />
      </div>
                        ...
                        <div className="bg-white/30 backdrop-blur-xl rounded-3xl border-2 border-white/40 overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-300 h-full flex flex-col">
                          ...
                          <div className="p-6 flex-1">
                            ...
                            <div className="flex gap-3" onClick={(e) => e.stopPropagation()}>
                              <Button
                                onClick={() => navigate(`/groups/${g.id}`)}
                                className="flex-1 bg-white/40 hover:bg-white/60 text-gray-800 border-2 border-white/50 rounded-xl py-3 font-medium backdrop-blur-sm"
                                size="sm"
                              >
                                View Details
                              </Button>
